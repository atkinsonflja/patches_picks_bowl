...
class WeeksControllerTest < ActionController::TestCase
  ...
  test "should create week" do
    assert_difference('Week.count') do
      post :create, week: { number: @week.number, previous_week_id: @week.previous_week_id, status: @week.status, winner: @week.winner }
    end
  ...
  test "should update week" do
    patch :update, id: @week, week: { number: @week.number, previous_week_id: @week.previous_week_id, status: @week.status, winner: @week.winner }
    assert_redirected_to week_path(assigns(:week))
  end
